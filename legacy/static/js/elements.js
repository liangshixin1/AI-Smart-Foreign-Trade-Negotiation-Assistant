...
const voiceCallSendBtn = document.getElementById("voice-call-send");
const voiceCallWindow = document.getElementById("voice-call-window");
...
const sectionEditorKnowledge = document.getElementById("section-editor-knowledge");
...
const theoryRelatedPracticesSection = document.getElementById("theory-related-practices");
const theoryRelatedPracticesStatus = document.getElementById("theory-related-practices-status");
const theoryRelatedPracticeList = document.getElementById("theory-related-practice-list");
...
const adminTheoryLessonHeading = document.getElementById("admin-theory-lesson-heading");
...
const adminTheoryDocxPublish = document.getElementById("admin-theory-docx-publish");
const adminTheoryDocxReset = document.getElementById("admin-theory-docx-reset");
const adminTheoryDocxProgress = document.getElementById("admin-theory-docx-progress");
const adminTheoryDocxProgressBar = document.getElementById("admin-theory-docx-progress-bar");
const adminTheoryDocxProgressLabel = document.getElementById("admin-theory-docx-progress-label");
...
const knowledgeCardCancel = document.getElementById("knowledge-card-cancel");
const knowledgeCardConfirm = document.getElementById("knowledge-card-confirm");
const knowledgeCardList = document.getElementById("knowledge-card-list");
const knowledgeCardSearch = document.getElementById("knowledge-card-search");
const knowledgeCardNew = document.getElementById("knowledge-card-new");
const knowledgeCardNameInput = document.getElementById("knowledge-card-name");
const knowledgeCardSummaryInput = document.getElementById("knowledge-card-summary");
const knowledgeCardTagsInput = document.getElementById("knowledge-card-tags");
const knowledgeCardBodyEditor = document.getElementById("knowledge-card-body");
const knowledgeCardImageInput = document.getElementById("knowledge-card-image");
const knowledgeCardImagePreview = document.getElementById("knowledge-card-image-preview");
const knowledgeCardRemoveImageBtn = document.getElementById("knowledge-card-remove-image");
const knowledgeCardStatus = document.getElementById("knowledge-card-status");
const knowledgeCardInsertTableBtn = document.getElementById("knowledge-card-insert-table");
const knowledgeCardClearBodyBtn = document.getElementById("knowledge-card-clear-body");
const challengeSelectorModal = document.getElementById("challenge-selector-modal");
const challengeSelectorChapter = document.getElementById("challenge-selector-chapter");
const challengeSelectorSection = document.getElementById("challenge-selector-section");
const challengeSelectorLabel = document.getElementById("challenge-selector-label");
const challengeSelectorPreview = document.getElementById("challenge-selector-preview");
const challengeSelectorClose = document.getElementById("challenge-selector-close");
...
const emailThreadEl = document.getElementById("email-thread");
const emailComposerEl = document.getElementById("email-composer");
const emailBannerEl = document.getElementById("email-mode-banner");
...
const emailDraftBtn = document.getElementById("email-draft");
const emailPolishBtn = document.getElementById("email-polish");
...
const copilotMinimizeBtn = document.getElementById("copilot-minimize");
const copilotInput = document.getElementById("copilot-input");
const copilotAssistBtn = document.getElementById("copilot-assist");
const copilotAgentBtn = document.getElementById("copilot-agent");
const copilotStopBtn = document.getElementById("copilot-stop");
const copilotStatus = document.getElementById("copilot-status");
const copilotOutput = document.getElementById("copilot-output");
const copilotCopyBtn = document.getElementById("copilot-copy");
const reviewModule = document.getElementById("review-module");
const reviewDocumentEl = document.getElementById("review-document");
const reviewSelectionPreview = document.getElementById("review-selection");
const reviewIssueInput = document.getElementById("review-issue");
const reviewFixInput = document.getElementById("review-fix");
const reviewSaveBtn = document.getElementById("review-save");
const reviewAnnotationsList = document.getElementById("review-annotations");
const reviewHintList = document.getElementById("review-hints");
const reviewContextList = document.getElementById("review-context");
...
const evaluationRecommendationsSection = document.getElementById("evaluation-recommendations-section");
const evaluationRecommendationsStatus = document.getElementById("evaluation-recommendations-status");
const evaluationRecommendationsList = document.getElementById("evaluation-recommendations-list");
const evaluationLoadingOverlay = document.getElementById("evaluation-loading");
const evaluationRingProgress = document.getElementById("evaluation-ring-progress");
const evaluationFeedbackCards = document.getElementById("evaluation-feedback-cards");
const evaluationAnalysisPanel = document.getElementById("evaluation-analysis-panel");
const evaluationLexicalPanel = document.getElementById("evaluation-lexical-panel");
const evaluationTabAnalysis = document.getElementById("evaluation-tab-analysis");
const evaluationTabLexical = document.getElementById("evaluation-tab-lexical");
const lexicalSuggestionsEl = document.getElementById("lexical-suggestions");
const lexicalSuggestionsStatus = document.getElementById("lexical-suggestions-status");
const evaluationPanel = document.getElementById("evaluation-panel");
const evaluationPanelClose = document.getElementById("evaluation-panel-close");
const evaluationToggle = document.getElementById("evaluation-toggle");
const knowledgePeek = document.getElementById("knowledge-peek");
const knowledgePeekTitle = document.getElementById("knowledge-peek-title");
const knowledgePeekSummary = document.getElementById("knowledge-peek-summary");
const knowledgePeekClose = document.getElementById("knowledge-peek-close");
const knowledgePeekBody = document.getElementById("knowledge-peek-body");
const knowledgePeekGraph = document.getElementById("knowledge-peek-graph");
const knowledgePeekGraphStatus = document.getElementById("knowledge-peek-graph-status");
const knowledgePeekJump = document.getElementById("knowledge-peek-jump");
const sessionListEl = document.getElementById("session-list");
const chatClientAvatarEl = document.getElementById("chat-client-avatar");
const chatClientInitialsEl = document.getElementById("chat-client-initials");
const chatClientNameEl = document.getElementById("chat-client-name");
const chatClientStatusEl = document.getElementById("chat-client-status");
const chatClientTimeEl = document.getElementById("chat-client-time");
const scenarioDrawerOverlay = document.getElementById("scenario-drawer-overlay");
const scenarioDrawer = document.getElementById("scenario-drawer");
const scenarioDrawerToggle = document.getElementById("scenario-drawer-toggle");
const scenarioDrawerClose = document.getElementById("scenario-drawer-close");
...
const adminKpiTotal = document.getElementById("admin-kpi-total");
const adminKpiProgress = document.getElementById("admin-kpi-progress");
const adminKpiAttention = document.getElementById("admin-kpi-attention");
const adminStudentSearch = document.getElementById("admin-student-search");
const adminStudentFilter = document.getElementById("admin-student-filter");
const adminStudentSort = document.getElementById("admin-student-sort");
const adminStudentTableEmpty = document.getElementById("admin-student-table-empty");
const adminTrendChart = document.getElementById("admin-trend-chart");
const adminTrendSectionFilter = document.getElementById("admin-trend-section-filter");
const adminTrendEmpty = document.getElementById("admin-trend-empty");
const adminActionHotspots = document.getElementById("admin-action-hotspots");
const adminActionEmpty = document.getElementById("admin-action-empty");
const adminKnowledgeWeakness = document.getElementById("admin-knowledge-weakness");
const adminKnowledgeEmpty = document.getElementById("admin-knowledge-empty");
const adminKnowledgeDrawer = document.getElementById("admin-knowledge-drawer");
const adminKnowledgeDrawerClose = document.getElementById("admin-knowledge-drawer-close");
const adminKnowledgeDrawerTitle = document.getElementById("admin-knowledge-drawer-title");
const adminKnowledgeDrawerHint = document.getElementById("admin-knowledge-drawer-hint");
const adminKnowledgeDrawerList = document.getElementById("admin-knowledge-drawer-list");
const adminGraphCanvas = document.getElementById("admin-graph-canvas");
const adminGraphRefresh = document.getElementById("admin-graph-refresh");
const adminGraphToggleRenderer = document.getElementById("admin-graph-toggle-renderer");
