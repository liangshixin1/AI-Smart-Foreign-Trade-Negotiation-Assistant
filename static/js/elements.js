...
const knowledgeCardCategorySelect = document.getElementById("knowledge-card-category");
const knowledgeCardTypeSelect = document.getElementById("knowledge-card-type");
const knowledgeCardDifficultySelect = document.getElementById("knowledge-card-difficulty");
const knowledgeCardImportanceSelect = document.getElementById("knowledge-card-importance");
...
const knowledgeCategoryTree = document.getElementById("knowledge-category-tree");
const knowledgeCategoryForm = document.getElementById("knowledge-category-form");
const knowledgeCategoryIdInput = document.getElementById("knowledge-category-id");
const knowledgeCategoryNameInput = document.getElementById("knowledge-category-name");
const knowledgeCategoryParentSelect = document.getElementById("knowledge-category-parent");
const knowledgeCategoryDescriptionInput = document.getElementById("knowledge-category-description");
const knowledgeCategorySaveBtn = document.getElementById("knowledge-category-save");
const knowledgeCategoryResetBtn = document.getElementById("knowledge-category-reset");
const knowledgeCategoryDeleteBtn = document.getElementById("knowledge-category-delete");
const knowledgeCategoryNewBtn = document.getElementById("knowledge-category-new");
const knowledgeCategoryRefreshBtn = document.getElementById("knowledge-category-refresh");
const knowledgeCategoryStatus = document.getElementById("knowledge-category-status");
const knowledgeImportExcelInput = document.getElementById("knowledge-import-excel-input");
const knowledgeImportDocxInput = document.getElementById("knowledge-import-docx-input");
const knowledgeImportStatus = document.getElementById("knowledge-import-status");
...
const knowledgeListStatus = document.getElementById("knowledge-list-status");
const knowledgeDetailForm = document.getElementById("knowledge-detail-form");
const knowledgeDetailOriginalName = document.getElementById("knowledge-detail-original-name");
const knowledgeDetailNameInput = document.getElementById("knowledge-detail-name");
const knowledgeDetailCategorySelect = document.getElementById("knowledge-detail-category");
const knowledgeDetailTypeSelect = document.getElementById("knowledge-detail-type");
const knowledgeDetailDifficultySelect = document.getElementById("knowledge-detail-difficulty");
const knowledgeDetailImportanceSelect = document.getElementById("knowledge-detail-importance");
const knowledgeDetailTagsInput = document.getElementById("knowledge-detail-tags");
const knowledgeDetailSummaryInput = document.getElementById("knowledge-detail-summary");
const knowledgeDetailSaveBtn = document.getElementById("knowledge-detail-save");
const knowledgeDetailNewBtn = document.getElementById("knowledge-detail-new");
